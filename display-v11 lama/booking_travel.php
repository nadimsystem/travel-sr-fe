...
<head>
    ...
    <script>
        ...
        window.initialView = 'bookingTravel';
    </script>
</head>
                ...
                <div v-if="view === 'bookingTravel' || view === 'bookingBus'" class="absolute inset-0 flex justify-center p-6 overflow-y-auto custom-scrollbar">
                   <div class="w-full max-w-5xl bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 flex flex-col md:flex-row h-fit min-h-[600px]">
                        <div class="w-full md:w-7/12 p-8 border-r border-slate-100 dark:border-slate-700">
                            <div class="mb-6 border-b border-slate-100 dark:border-slate-700 pb-4"><h2 class="text-xl font-extrabold text-sr-blue dark:text-white">Booking Travel</h2></div>
                             <div class="space-y-4">
                                <div class="grid grid-cols-3 gap-2 p-1 bg-slate-50 dark:bg-slate-700 rounded-xl border border-slate-200 dark:border-slate-600">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                     <div>
                                         ...
                                         <input type="text" v-model="bookingForm.data.passengerName" class="w-full p-2.5 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 dark:text-white rounded-lg text-sm outline-none focus:border-blue-500">
                                     </div>
                                     <div>
                                         <label class="text-[10px] font-bold text-slate-400 uppercase block mb-1">WhatsApp</label>
                                         <input type="text" v-model="bookingForm.data.passengerPhone" class="w-full p-2.5 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 dark:text-white rounded-lg text-sm outline-none focus:border-blue-500">
                                     </div>
                                </div>
                                ...
                                <div v-if="bookingForm.data.serviceType==='Dropping'" class="col-span-2 animate-fade-in">
                        ...
                        <div class="w-full md:w-5/12 bg-slate-50 dark:bg-slate-900 p-8 flex flex-col overflow-y-auto custom-scrollbar">
                             ...
                             <div class="mt-auto pt-6 border-t border-slate-200 dark:border-slate-700">
                                <button @click="saveBooking()" :disabled="currentTotalPrice === 0" class="w-full py-3 bg-sr-blue dark:bg-blue-600 hover:bg-slate-800 disabled:bg-slate-300 text-white font-bold rounded-xl shadow-lg">Proses Booking</button>
                            </div>
                        </div>
                   </div>
                </div>
