                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="bg-slate-50 dark:bg-slate-700/50 p-3 rounded-lg">
                                        ...
                                        <div class="font-bold text-slate-700 dark:text-slate-200">{{ formatRupiah(r.prices?.umum || 0) }}</div>
                                    </div>
                                    <div class="bg-slate-50 dark:bg-slate-700/50 p-3 rounded-lg">
                                        <div class="text-[10px] font-bold text-slate-400 uppercase mb-1">Pelajar</div>
                                        <div class="font-bold text-slate-700 dark:text-slate-200">{{ formatRupiah(r.prices?.pelajar || 0) }}</div>
                                    </div>
                                    <div class="bg-slate-50 dark:bg-slate-700/50 p-3 rounded-lg">
                                        <div class="text-[10px] font-bold text-slate-400 uppercase mb-1">Dropping</div>
                                        <div class="font-bold text-slate-700 dark:text-slate-200">{{ formatRupiah(r.prices?.dropping || 0) }}</div>
                                    </div>
                                    <div class="bg-slate-50 dark:bg-slate-700/50 p-3 rounded-lg">
                                        <div class="text-[10px] font-bold text-slate-400 uppercase mb-1">Carter</div>
                                        <div class="font-bold text-slate-700 dark:text-slate-200">{{ formatRupiah(r.prices?.carter || 0) }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
