...
<body class="h-screen w-screen bg-slate-50 text-slate-800 dark:bg-slate-900 dark:text-slate-100">
    ...
    <div id="app" class="flex h-full w-full" v-cloak>
        ...
        <?php $currentPage = 'assets'; include 'components/sidebar.php'; ?>
        ...
        <main class="flex-1 flex flex-col min-w-0 bg-slate-50 dark:bg-slate-900 relative h-full overflow-hidden transition-colors duration-300">
            <header class="h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between px-3 sm:px-6 shadow-sm z-10 flex-shrink-0 transition-colors duration-300">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 hidden sm:block">Sistem Operasional V11 Ultimate</p>
                    </div>
                </div>
