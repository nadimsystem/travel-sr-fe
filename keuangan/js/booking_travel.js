...
async function saveBooking() {
    ...
    try {
        ...
        const bookingData = {
            ...
            dropoffAddress: isCustomRoute ? destination : (document.getElementById('dropoffAddress').value + (document.getElementById('dropoffMapLink').value ? ', ' + document.getElementById('dropoffMapLink').value : '')),
