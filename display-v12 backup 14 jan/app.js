...
import { dataMixin } from './js/modules/data.js?v=12.12';
import { utilsMixin } from './js/modules/utils.js?v=12.12';
import { authMixin } from './js/modules/auth.js?v=12.12';
import { uiMixin } from './js/modules/ui.js?v=12.12';
import { bookingMixin } from './js/modules/booking.js?v=12.12';
import { paymentMixin } from './js/modules/payment.js?v=12.12';
import { packageMixin } from './js/modules/package.js?v=12.12';
import { dispatcherMixin } from './js/modules/dispatcher.js?v=12.12';
import { assetsMixin } from './js/modules/assets.js?v=12.12';
import { scheduleMixin } from './js/modules/schedule.js?v=12.12';
import { reportMixin } from './js/modules/report.js?v=12.12';
...
window.app = createApp({
    ...
    methods: {
        ...
        updateSidebarCounts() {
            ...
            if (elValidation) elValidation.innerText = this.pendingValidationCount; // From computed? 
            if (elDispatch) elDispatch.innerText = this.pendingDispatchCount; // From computed?
        },
