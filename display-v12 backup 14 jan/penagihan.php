                    ...
                    <div v-if="paymentForm.payment_method === 'Transfer'" class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" v-model="paymentForm.payment_location" class="w-full p-3 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 rounded-xl text-sm outline-none" placeholder="ke BRI/BCA/Dana?">
                            </div>
                        </div>
                        <div>
