...
createApp({
    ...
    methods: {
        ...
        handleFileUpload(event) {
            ...
            reader.onload = (e) => {
                this.editForm.ktmProof = e.target.result;
            };
        ...
        handlePaymentProofUpload(event) {
            ...
            const reader = new FileReader();
            reader.onload = (e) => {
                this.editForm.paymentProof = e.target.result;
            };
            reader.readAsDataURL(file);
        },
            ...
            try {
                const res = await fetch('api.php', {
                    ...
                    body: JSON.stringify({
                        ...
                        ktmProof: this.editForm.ktmProof,
                        paymentProof: this.editForm.paymentProof,
